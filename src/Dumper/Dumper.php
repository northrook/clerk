...
class Dumper
{
    ...
    public const string HIDDEN_VALUE = Describer::HiddenValue;
    ...
    private function __construct( array $options = [] )
    {
        ...
        $location = $location ? ~0 : (int) $location;
    ...
    public static function renderAssets() : void
    {
        ...
        $s         = \file_get_contents( "{$assets}/toggle.css" )
        ...
        if ( ! Debugger::isEnabled() ) {
            $s = '(function(){'.\file_get_contents( "{$assets}/toggle.js" ).'})();'
                 .'(function(){'.\file_get_contents( "{$assets}/helpers.js" ).'})();'
                 .'(function(){'.\file_get_contents( __DIR__.'/../Dumper/assets/dumper.js' ).'})();';
            echo "<script{$nonceAttr}>", \str_replace(
                ['<!--', '</s'],
                ['<\!--', '<\/s'],
                Helpers::minifyJs( $s ),
            ), "</script>\n";
